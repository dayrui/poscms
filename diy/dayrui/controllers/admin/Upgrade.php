...
class Upgrade extends M_Controller {
    ...
    public function vlist() {
        ...
        $data = dr_catcher_data('http://www1.dayrui.com/index.php?c=fc&m=vlist&my='.DR_VERSION_ID);

        if (!$data) {
            exit('<tr><td align="left" colspan="5" style="color:red; padding: 30px 10px"> 无法从服务器上获取版本信息！ </td></tr>');
        }
    ...
    public function update() {
        ...
        define('UPVID', $vid);
        $data = dr_catcher_data(urldecode('http://www1.dayrui.com/index.php?c=fc&m=down&id='.$vid.'&sn='.$sid));
