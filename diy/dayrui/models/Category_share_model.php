        ...
        if (is_array($this->categorys)) {
            ...
            foreach ($this->categorys as $catid => $cat) {
                ...
                if ($cat['mid'] && $cat['pid']) {
                    ...
                    $this->categorys[$catid]['mid'] = $pmid;
                    if ($pmid && !$this->update_sqls[md5(dr_array2string($ids))]) {
                        $this->update_sqls[md5(dr_array2string($ids))] = 1;
                        $this->db->where_in('id', $ids)->update($this->tablename, array('mid' => $pmid));
                    }
                }*/
