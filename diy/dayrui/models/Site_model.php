...
class Site_model extends CI_Model {
	...
	public function add_site($data) {
        ...
        $this->db->query("DROP TABLE IF EXISTS `".$this->db->dbprefix($id.'_share')."`");
        $this->db->query(trim("
        ...
        $this->db->query("DROP TABLE IF EXISTS `".$this->db->dbprefix($id.'_share_extend')."`");
        $this->db->query(trim("
        ...
        $this->db->query("DROP TABLE IF EXISTS `".$this->db->dbprefix($id.'_share_search')."`");
        $this->db->query(trim("
        ...
        $this->db->query("DROP TABLE IF EXISTS `".$this->db->dbprefix($id.'_share_search_index')."`");
        $this->db->query(trim("
