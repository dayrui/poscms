...
/* v3.1.0  */
class D_Member_Extend_Verify extends M_Controller {
    ...
    public function index() {
        ...
        $this->template->display('module_extend_verify_index.html');
    }
    ...
    public function edit() {
        ...
        $this->template->display('module_extend_verify_edit.html');
    }
